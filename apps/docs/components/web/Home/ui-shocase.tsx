            ...
            <div className="relative z-10 container mx-auto px-6 py-12">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="group rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/10"
                    >
                        <div className="mb-4 flex items-center">
                            <Laptop className="mr-3 text-blue-400" size={24} />
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="group rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/10 lg:col-span-2 lg:row-span-2"
                    >
                        <div className="mb-4 flex items-center">
                            <Layers
                    ...
                    >
                        <div className="mb-4 flex items-center">
                            <Code className="mr-3 text-cyan-400" size={20} />
                            <h3 className="text-lg font-semibold">
                                Flip Words
                            </h3>
                        </div>
                        <p className="mb-6 text-sm text-gray-400">
                            Animated text that cycles through words with smooth
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="group rounded-3xl border border-white/10 p-6 transition-all duration-300 hover:border-white/20 lg:col-span-2"
                    >
                        <div className="mb-4 flex items-center">
                            <Upload
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="group flex flex-col justify-center rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/10"
                    >
                        <div className="mb-4 flex items-center">
                            <Bell className="mr-3 text-green-400" size={20} />
                            <h3 className="text-lg font-semibold">
                                iOS Notifications
                            </h3>
                        </div>
                        <p className="mb-4 text-sm text-gray-400">
                            Stack of notifications with iOS-style animations.
                        </p>
