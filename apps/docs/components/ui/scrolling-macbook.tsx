...
const ScrollingMacbook = () => {
    ...
    return (
        <div>
            ...
            >
                <motion.div className="relative isolate [perspective:1000px]">
                    <motion.div
                        style={{
                    ...
                    >
                        ...
                        <div className="flex h-full w-full flex-col items-center justify-center rounded-sm p-2 shadow-[0_1px] shadow-white/5">
                            <img
                    ...
                    <div className="relative h-[0.75rem] w-[14.5rem] rounded-t-sm rounded-b-md bg-gradient-to-b from-gray-600 from-65% to-gray-700 shadow-[inset_0_1px_0px] shadow-white/10 before:absolute before:top-0 before:left-1/2 before:h-[0.125rem] before:w-[1.25rem] before:-translate-x-1/2 before:rounded-b-full before:bg-gray-700 before:shadow-[inset_2px_0_1px_-2px_theme(colors.black/50%),inset_-2px_0_1px_-2px_theme(colors.black/50%),0_1px_0_theme(colors.white/10%)]"></div>
                </motion.div>
            </div>
        </div>
    );
