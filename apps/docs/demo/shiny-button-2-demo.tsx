...
export const ShinyButtonDemo2 = () => {
    return (
        <div className="divide grid h-full w-full grid-cols-2 flex-col items-center justify-between divide-x divide-dashed divide-neutral-600">
            <div className="divide-y divide-dashed divide-neutral-600">
                <div className="col-span-1 flex aspect-[3/1] items-center justify-center">
                    <ShinyButton
            ...
            <div className="divide-y divide-dashed divide-neutral-600">
                <div className="col-span-1 flex aspect-[3/1] h-full w-full flex-col items-center justify-center gap-4">
                    <ShinyButton
